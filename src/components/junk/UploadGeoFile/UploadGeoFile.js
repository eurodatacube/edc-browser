...
export class UploadGeoFile extends Component {
  state = {
    error: null,
  };
  ...
  render() {
    const fileUploadTitle = `File upload`;
    const fileUploadText = `Upload a KML/KMZ, GPX or GEOJSON file to create area of interest. Area will be used for clipping when exporting an image.`;
    const dropAFileString = `Drop KML/KMZ, GPX, GEOJSON file or search your computer`;
